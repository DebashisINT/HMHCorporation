package com.breezefsmhmhcorporation.features.logoutsync.presentation
...
import com.breezefsmhmhcorporation.app.AppDatabase
...
import com.breezefsmhmhcorporation.app.utils.Toaster
import com.breezefsmhmhcorporation.base.BaseResponse
import com.breezefsmhmhcorporation.base.presentation.BaseActivity
import com.breezefsmhmhcorporation.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefsmhmhcorporation.features.billing.api.AddBillingRepoProvider
import com.breezefsmhmhcorporation.features.billing.model.AddBillingInputParamsModel
...
import com.breezefsmhmhcorporation.features.dashboard.presentation.ReasonDialog
...
import com.breezefsmhmhcorporation.features.document.model.AddEditDocumentInputParams
import com.breezefsmhmhcorporation.features.document.model.DocumentAttachmentModel
...
import com.breezefsmhmhcorporation.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefsmhmhcorporation.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefsmhmhcorporation.features.orderhistory.model.*
...
import com.breezefsmhmhcorporation.features.quotation.model.AddQuotInputModel
import com.breezefsmhmhcorporation.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmhmhcorporation.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefsmhmhcorporation.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefsmhmhcorporation.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefsmhmhcorporation.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefsmhmhcorporation.features.timesheet.model.AddTimeSheetInputModel
import com.breezefsmhmhcorporation.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefsmhmhcorporation.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefsmhmhcorporation.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefsmhmhcorporation.mappackage.SendBrod
import com.breezefsmhmhcorporation.widgets.AppCustomTextView
import com.breezefsmhmhcorporation.MonitorService
...
import com.breezefsmhmhcorporation.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefsmhmhcorporation.features.login.model.GetConcurrentUserResponse
import com.breezefsmhmhcorporation.features.performance.model.Gps_status_list
import com.breezefsmhmhcorporation.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefsmhmhcorporation.features.returnsOrder.ReturnProductList
import com.breezefsmhmhcorporation.features.returnsOrder.ReturnRequest
import com.breezefsmhmhcorporation.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmhmhcorporationlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmhmhcorporationlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmhmhcorporationlogsample/log.zip").path);
